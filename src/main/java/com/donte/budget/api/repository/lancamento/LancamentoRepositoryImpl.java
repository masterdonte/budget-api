...
import com.donte.budget.api.model.Categoria_;
import com.donte.budget.api.model.Lancamento;
import com.donte.budget.api.model.Lancamento_;
import com.donte.budget.api.model.Pessoa_;
...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
	...
	public Page<Lancamento> filtrar(LancamentoFilter lancamentoFilter, Pageable pageable) {
		...
		//return query.getResultList(); #Com o retorno de List e sem o parametro pageable
	...
	public List<LancamentoEstatisticaCategoria> porCategoria(LocalDate mesReferencia) {
		...
		CompoundSelection<LancamentoEstatisticaCategoria> selection = criteriaBuilder.construct(LancamentoEstatisticaCategoria.class, 
	...
	public List<LancamentoEstatisticaDia> porDia(LocalDate mesReferencia) {
		...
		CompoundSelection<LancamentoEstatisticaDia> selection = criteriaBuilder.construct(LancamentoEstatisticaDia.class, 
	...
	public List<LancamentoEstatisticaPessoa> porPessoa(LocalDate inicio, LocalDate fim) {
		...
		CompoundSelection<LancamentoEstatisticaPessoa> selection = criteriaBuilder.construct(LancamentoEstatisticaPessoa.class, 
				root.get(Lancamento_.tipo), 
